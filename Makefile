...
$(img): ipl.bin head.bin bootpack.bin hello.bin hello2.bin a.hrb hello4.hrb winhelo.hrb winhelo2.hrb winhelo3.hrb star1.hrb lines.hrb walk.hrb noodle.hrb beepdown.hrb color.hrb color2.hrb crack1.hrb crack7.hrb
...
crack7.hrb: crack7.s api.s api.ld
	$(AS) $(ASFLAGS) -o crack7.o crack7.s
	$(AS) $(ASFLAGS) -o api.o api.s
	$(LD) $(LDFLAGS) -T api.ld -o $@ api.o crack7.o
