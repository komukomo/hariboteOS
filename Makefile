...
$(img): ipl.bin head.bin bootpack.bin a.hrb hello4.hrb winhelo.hrb winhelo2.hrb winhelo3.hrb star1.hrb lines.hrb walk.hrb noodle.hrb beepdown.hrb color.hrb color2.hrb typeint.hrb type.hrb
